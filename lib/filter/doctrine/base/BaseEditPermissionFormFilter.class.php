...
/**
 * EditPermission filter form base class.
 *
 * @package    poomtshak
 * @subpackage filter
 * @author     PoUpA
 ...
 */
abstract class BaseEditPermissionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('edit_permission_filters[%s]');
